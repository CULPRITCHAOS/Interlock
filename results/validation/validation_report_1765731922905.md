...
**Generated:** 2025-12-14T17:05:22.905Z
...
- Test 2 (Restart during cooldown): ✓ Cooldown=29999ms
...
-   - Norm: 4.349, Sparsity: 0.008
-   - Entropy: 4.089, Centroid: centroid-34f700d...
- Test 4 (Incident Sanitization): ✓
-   - Fields redacted: query, result, error.stack, error.message, sessionId, rawPayload
-   - Size reduction: 2822 → 1341
- Test 5 (No Raw Payload Survives): ✓

### ✅ Hardware Fingerprint

**Goal:** Verify hardware mismatch invalidates cached state

**Metrics:**

| Metric | Value |
|--------|-------|
| fingerprintCollected | 1 |
| sameHardwareLoads | 1 |
| fingerprintComparison | 1 |
| changedMemoryInvalidates | 1 |
| conservativeBoot | 1 |

**Details:**

- Test 1 (Fingerprint collected): ✓ Memory=31992MB, Cores=16
- Test 2 (Same hardware loads): ✓ HardwareMismatch=false, BootState=normal
- Test 3 (Fingerprint comparison): ✓ Same=true, 60%Less=false, 10%Less=true
-   Mismatch reasons: Memory changed from 31992MB to 12797MB (60.0% difference exceeds 20% tolerance)
- Test 4 (Memory change invalidates): ✓ HardwareMismatch=true
- Test 5 (Conservative boot): ✓ State=open, ConfidenceCleared=true
-   Mismatch warning: Memory changed from 9598MB to 31992MB (233.3% difference exceeds 20% tolerance)...

### ✅ Class Certification Integrity

**Goal:** Verify Interlock class derivation, anti-gaming, badge expiry, and tamper-evidence

**Metrics:**

| Metric | Value |
|--------|-------|
| qualityFloorAntiGaming | 1 |
| reflexOverrideAntiGaming | 1 |
| expiryTriggers | 1 |
| deterministicOutput | 1 |
| classStability | 1 |
| signatureDeterministic | 1 |
| signatureVerifiable | 1 |
| tamperDetection | 1 |

**Details:**

- Test 1 (qualityFloor anti-gaming): ✓
-   Full config (qualityFloor enabled): Class V ✓
-   qualityFloorEnabled=false: Class IV ✓
-   qualityFloor=0: Class IV ✓
- Test 2 (reflex/hysteresis anti-gaming): ✓
-   Full config (reflex+hysteresis enabled): Class IV ✓
-   reflexOverrideEnabled=false: Class III ✓
-   hysteresisEnabled=false: Class III ✓
- Test 3 (expiry triggers staleness): ✓
-   Expired (-30 days): isStale=true, hasWarning=true
-   Valid (+30 days): isStale=false, hasWarning=false
-   Soon (+5 days): isStale=false, hasWarning=true
- Test 4 (deterministic output): ✓
-   Run 1: Class V, reasons=19
-   Run 2: Class V, reasons=19
-   Config fingerprint: deterministic (cfg_44357104)
- Test 5 (class stability): ✓
-   Config A: Class V
-   Config B (reordered): Class V
- Test 6 (signature deterministic): ✓
-   Signature present: Yes
-   Signature: fb54f847d9ea1fa3...
-   Re-computed matches: Yes
- Test 6 (signature verifiable): ✓
- Test 7 (tamper detection): ✓
-   Original class: V
-   Tampered class: I
-   Tamper detected: Yes
-   Warning: SECURITY WARNING: Certification Badge Tampered - signature m...
...
- ✅ Hardware fingerprint prevents "hardware lottery" crashes
- ✅ Class certification integrity (anti-gaming, expiry, tamper-evidence)

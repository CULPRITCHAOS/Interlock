...
**Generated:** 2025-12-13T18:22:17.114Z
**Overall Result:** ❌ SOME TESTS FAILED

**Summary:** 11/12 tests passed. Review failures.
...
**Goal:** Verify Interlock class derivation, anti-gaming, and badge expiry

**Metrics:**

| Metric | Value |
|--------|-------|
| qualityFloorDowngrade | 0 |
| reflexOverrideDowngrade | 0 |
| expiryTriggers | 1 |
...
- Test 1 (qualityFloor disable → downgrade): ✗
-   With qualityFloor: Class V
-   Without qualityFloor: Class IV (downgraded=false)
-   With qualityFloor=0: Class IV (downgraded=false) ✗
- Test 2 (reflex/hysteresis disable → downgrade): ✗
-   With reflexOverride: Class IV
-   Without reflexOverride: Class III (downgraded=false)
-   Without hysteresis: Class III (downgraded=false)
...
-   Config fingerprint: deterministic (cfg_7ae772f7)
...
- ❌ Class certification integrity (anti-gaming, expiry)

"""
Interlock Phase IV: Certification Report Generator
==================================================
...
def _get_predictable_items() -> List[str]:
    """Return list of what Interlock CAN predict."""
    return [
...
def _get_unpredictable_items() -> List[str]:
    """Return list of what Interlock CANNOT predict."""
    return [
...
def generate_certification_markdown(report: CertificationReport) -> str:
    ...
    # Header
    lines.append("# Interlock Phase IV – Ground-Truth Certification Report")
    lines.append("")
    lines.append("> Interlock does not optimize systems.")
    lines.append("> It prevents them from breaking.")
    lines.append("")
    ...
    lines.append("> It states explicitly what Interlock can and cannot do.")
    lines.append("")
    
    lines.append("### ✅ What Interlock CAN Predict")
    lines.append("")
    for item in report.what_can_predict:
        lines.append(f"- {item}")
    lines.append("")
    
    lines.append("### ❌ What Interlock CANNOT Predict")
    lines.append("")
    ...
    lines.append("---")
    lines.append("")
    lines.append("*Generated by Interlock Phase IV Ground-Truth Certification Engine*")
    lines.append("")
    lines.append("**Guiding Principle:** Interlock does not optimize systems. It prevents them from breaking.")

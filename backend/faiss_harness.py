"""
Interlock Phase IV: Real FAISS Ground-Truth Harness
===================================================
...
logger = logging.getLogger("interlock.faiss_harness")
...
def generate_calibration_markdown(calibration: ForecastCalibration) -> str:
    ...
    lines.append("# Interlock Phase IV – Forecast Calibration Report")
    lines.append("")
    lines.append("> Interlock does not prevent failure. It makes failure visible before it happens.")
    lines.append("")
    ...
    lines.append("---")
    lines.append("*Generated by Interlock Phase IV Forecast Calibration Engine*")

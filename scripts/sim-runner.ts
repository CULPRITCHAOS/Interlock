/**
 * SOS Tournament - Headless Simulation Runner
 * =============================================
...
const DOMAIN_FINGERPRINTS: Record<string, WorkloadFingerprint> = {
  ...
  postgres: { datasetSize: 100000, dimensions: 1, queryPattern: 'sequential', targetMetric: 'latency', k: 1 },
  compression: { datasetSize: 50000, dimensions: 256, queryPattern: 'random', targetMetric: 'memory', k: 1 },
  prompts: { datasetSize: 1000, dimensions: 512, queryPattern: 'clustered', targetMetric: 'recall', k: 5 }
};
...
function generateMarkdownReport(
  ...
  lines.push(`# SOS Tournament Run Report`);
  lines.push(``);
  ...
  lines.push(`---`);
  lines.push(`*Generated by SOS Tournament Benchmark Harness*`);
...
function main(): void {
  ...
  console.log(`\n=== SOS Tournament Headless Runner ===`);
